    ...
    <div class="panel-body" style="padding-bottom:0px;">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <form action="service.user_Selects1_Service"  method="get" id="formSearch" class="form-horizontal">
...
$(function(){	
    	 ...
    	 $("#btn1").click(function(){
        	if(pagecurrent>=2){
        		...
        		//idd--;
            // get方式的Ajax请求
            $.get("${ pageContext.request.contextPath}/service.user_Selects1_Service2",{"idd":pagecurrent}
            ,function(data){
           //构建html
