...
public class admin_Selects_Service6 extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public admin_Selects_Service6() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//////////////////////////
		// 查询
		String ktjbdm1 = (String) request.getSession().getAttribute("ktjbdm1");
		System.out.println(ktjbdm1);
